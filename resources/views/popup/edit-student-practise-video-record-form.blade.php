...
<style>
    #edit-student-practise-video-record-form {
        display: none;
        position: fixed;
    ...
    #edit-student-practise-video-record-form-message {
        color: green;
        margin-top: 10px;
        text-align: center;
        font-weight: 500;
...
<div id="edit-student-practise-video-record-form">
    <div class="student-practise-video-record-form-modal">
        <button class="close-btn" onclick="document.getElementById('edit-student-practise-video-record-form').style.display='none'">&times;</button>
        <h2>Sửa thông tin Student Practise Video Record</h2>
        <form id="update-student-practise-video-record-form">
            <label>Student Practise Video Record ID:</label>
            <input type="text" name="student_practise_video_record_id" readonly>
            <label>Student:</label>
            <select name="student_id" id="edit-student-practise-video-record-student-select" required>
                <option value="">-- Chọn Student --</option>
                <!-- Option sẽ được render động bằng JS -->
            </select>

            <label> Practise Video:</label>
            <select name="practise_video_id" id="edit-student-practise-video-record-video-select" required>
        ...
        <div id="edit-student-practise-video-record-form-message"></div>
    </div>
</div>
