...
<div id="delete-topic-form">
    <div class="delete-confirm-modal">
        <div style="font-size:1.1rem; margin-bottom:18px;">
            Bạn có chắc chắn muốn xóa dữ liệu này?
        </div>
        <button class="btn-cancel" onclick="closeDeleteTopicPopup()">Hủy</button>
        <button class="btn-delete" onclick="confirmDeleteTopic()">Xóa</button>
        <div id="delete-topic-form-message" style="margin-top:10px;color:red;"></div>
    </div>
</div>
