...
<div id="edit-topic-form">
    <div class="topic-form-modal">
        <button class="close-btn" onclick="document.getElementById('edit-topic-form').style.display='none'">&times;</button>
        <h2>Sửa thông tin Topic</h2>
        <form id="update-topic-form">
            <label>Topic ID:</label>
            <input type="text" name="topic_id" readonly>
            <label>Course:</label>
            <select name="course_id" id="edit-topic-course-select" required>
            ...
            <label>Số từ:</label>
            <input type="number" name="number_of_word" required min="0">
            <button type="submit">Cập nhật</button>
        </form>
        <div id="edit-topic-form-message"></div>
    </div>
</div>
