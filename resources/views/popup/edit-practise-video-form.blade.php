<style>
    ...
    #edit-practise-video-form-message {
        color: green;
        margin-top: 10px;
        text-align: center;
        font-weight: 500;
...
<div id="edit-practise-video-form">
    <div class="practise-video-form-modal">
        <button class="close-btn" onclick="document.getElementById('edit-practise-video-form').style.display='none'">&times;</button>
        <h2>Sửa Practise Video</h2>
        <form id="update-practise-video-form">
            <label>Practise Video ID:</label>
            <input type="text" name="practise_video_id" readonly>

            <label>Khóa học:</label>
            <select name="course_id" id="edit-practise-video-course-select" required>
        ...
        <div id="edit-practise-video-form-message"></div>
    </div>
</div>
