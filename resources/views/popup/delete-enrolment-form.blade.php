...
<div id="delete-enrolment-form">
    <div class="delete-confirm-modal">
        <div style="font-size:1.1rem; margin-bottom:18px;">
            Bạn có chắc chắn muốn xóa dữ liệu này?
        </div>
        <button class="btn-cancel" onclick="closeDeleteEnrolmentPopup()">Hủy</button>
        <button class="btn-delete" onclick="confirmDeleteEnrolment()">Xóa</button>
        <div id="delete-enrolment-form-message" style="margin-top:10px;color:red;"></div>
    </div>
</div>
