...
<style>
    #edit-student-topic-record-form {
        display: none;
        position: fixed;
    ...
    #edit-student-topic-record-form-message {
        color: green;
        margin-top: 10px;
        text-align: center;
        font-weight: 500;
...
<div id="edit-student-topic-record-form">
    <div class="student-topic-record-form-modal">
        ...
        <form id="update-student-topic-record-form">
            ...
            <select name="is_completed" id="edit-topic-is-completed-select" required>
        ...
        <div id="edit-student-topic-record-form-message"></div>
    </div>
</div>
